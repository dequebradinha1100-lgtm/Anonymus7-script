...
-- [CONFIGURAÇÃO DE KEYS LOCAIS] -- Adicione os usuários, keys e a data de expiração no formato "YYYY-MM-DD" local WhitelistDB = {     ["mk-vip"] = {User = "mWKAAdaJSKp", Expires = "2026-08-11"},
    ["SCRIPTVIP"] = {User = LocalPlayer.Name, Expires = "2026-12-31"},
    ["KEY-nk"] = {User = "seraphishXC55", Expires = "2026-06-08"},
